/*
   'src_pm_pgpNetPMEvents.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Tue Sep  4 10:25:31 2012
*/
#include"cobf.h"
#ifdef _WIN32
...
bb161*bb311,bbu bb578,bbu bb940);bbu bb1869(bb303*bbj,bbq bb503);bbb
bb1847(bb303*bbj);bbb bb1960(bb303*bbj);bbu bb1790(bb303*bbj,bb408*
bb614);bbu bb1931(bb303*bbj,bb408*bb614);bbb bb1934(bb32*bbj,bb178
bb103);bbb bb1867(bb32*bbj,bb178 bb103);bbb bb1817(bb32*bbj,bbd bb26,
bbd bb941);
#ifdef UNDER_CE
#define bb1916 64
#endif
...
(bb324*bb817,bb414*bb1490);bbu bb1869(bb303*bbj,bbq bb503){bb31(bbj);
bbj->bb907=bb137(bb503,bb11(bbj->bb907[0 ]));bbm(!bbj->bb907)bb2 0 ;bbj
->bb503=bb503;bb141(&bbj->bb962);bb2 1 ;}bbb bb1847(bb303*bbj){bb31(
bbj);bbm(bbj->bb907){bb106(bbj->bb907);bbj->bb907=bb90;}bbj->bb503=0 ;
bb144(&bbj->bb962);}bbb bb1960(bb303*bbj){bb31(bbj);bb133(&bbj->bb962
);bbj->bb385=0 ;bbj->bb451=0 ;bb132(&bbj->bb962);}bbu bb1790(bb303*bbj,
bb408*bb614){bbu bb35=0 ;bb31(bb614&&bbj);bbm(bbj->bb907&&bb614){bb133
(&bbj->bb962);{bbd bb503=bbj->bb503;bbm(bbj->bb451+1 >bb503){bbj->
bb385=(bbj->bb385+1 )%bb503;bbj->bb451--;}bb81(bbj->bb907+(bbj->bb385+
bbj->bb451++)%bb503,bb614,bb11( *bb614));bb35=1 ;}bb132(&bbj->bb962);}
bb2 bb35;}bbu bb1931(bb303*bbj,bb408*bb614){bbu bb35=0 ;bb31(bb614);
bbm(bbj&&bbj->bb907&&bb614){bb133(&bbj->bb962);bbm(bbj->bb451){bbd
bb503=bbj->bb503;bb81(bb614,bbj->bb907+bbj->bb385,bb11( *bb614));bbj
->bb385=(bbj->bb385+1 )%bb503;bbj->bb451--;bb35=1 ;}bb132(&bbj->bb962);
}bb2 bb35;}bbb bb1934(bb32*bbj,bb178 bb103){bb408 bb96={0 };bb1258*
bb27=(bb1258* )bb96.bb1223;bb96.bb131=bb1355;bb81(bb27->bb103,bb103,
bb11(bb178));bb1790(&bbj->bb1044,&bb96);}bbb bb1867(bb32*bbj,bb178
bb103){bb408 bb96={0 };bb1233*bb27=(bb1233* )bb96.bb1223;bb96.bb131=
bb1357;bb81(bb27->bb103,bb103,bb11(bb178));bb1790(&bbj->bb1044,&bb96);
}bbb bb1817(bb32*bbj,bbd bb26,bbd bb941){bb408 bb96={0 };bb1269*bb27=(
bb1269* )bb96.bb1223;bb96.bb131=bb1354;bb27->bb26=bb26;bb27->bb941=
bb941;bb1790(&bbj->bb1044,&bb96);}
